...
REPO_BRANCH = "main"   # v3.1: default to main branch
BINARY_NAME = "ai"
...
def main():
    ...
    try:
        ...
        if latest_ver >= (2, 8, 5):
            print("    ai gguf-info               # inspect GGUF metadata + template")
            print("    ai quant                   # show best quant tier for your RAM")
            print("    ai compare \"hello!\"       # side-by-side model comparison")
            print("    ai snap save my-setup      # save current config snapshot")
            print("    ai perf                    # benchmark tokens/sec for active model")
            print("    ai gui                     # curses TUI v5.3 (wider + readable)")
            print("    ai gui+                    # tkinter GUI+ v3 (1.75× · 8 tabs)")
